...
void search(struct DoublyLinkListNode *head_pointer, int position)
{
...
void searchNode(struct DoublyLinkListNode *head_pointer, int position)
{
    struct DoublyLinkListNode *before = head_pointer;
    for (int i = 0; i < position; i++)
    {
...
struct DoublyLinkListNode *locateNode(struct DoublyLinkListNode *head_pointer, int position)
{
    struct DoublyLinkListNode *before = head_pointer;
    for (int i = 0; i < position; i++)
    {
...
int main()
{
    ...
    printList(list);
    search(list, 2);
    struct DoublyLinkListNode *curr = locateNode(list, 2);
    ...
    printList(list);
    searchNode(list, 1);
    struct DoublyLinkListNode *deleteIndexOne = locateNode(list, 1);
    delete (&list, deleteIndexOne);
    printList(list);
    struct DoublyLinkListNode *deleteLastIndex = locateNode(list, 2);
    delete (&list, deleteLastIndex);
    printList(list);
    struct DoublyLinkListNode *deleteFirstIndex = locateNode(list, 0);
